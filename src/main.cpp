...
int COINBASE_MATURITY_SWITCH = 25770;
...
const string strMessageMagic = "Copico Signed Message:\n";
...
#ifdef ENABLE_WALLET
// copico: attempt to generate suitable proof-of-stake
