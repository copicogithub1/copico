...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeCopicoCAmount"))
        settings.setValue("nAnonymizeCopicoCAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeCopicoCAmount = settings.value("nAnonymizeCopicoCAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeCopicoCAmount"))
        SoftSetArg("-anonymizeCopicoCamount", settings.value("nAnonymizeCopicoCAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeCopicoCAmount:
            nAnonymizeCopicoCAmount = value.toInt();
            settings.setValue("nAnonymizeCopicoCAmount", nAnonymizeCopicoCAmount);
            emit anonymizeCopicoCAmountChanged(nAnonymizeCopicoCAmount);
            break;
        default:
            break;
        }
